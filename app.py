        ...
        with tab_ov:
            if not df_filtered.empty:
                ...
                with c2:
                    ...
                    def get_sent_label(s):
                        if s > 0.1: return "Positive 😊"
                        elif s < -0.1: return "Negative 😡"
                        return "Neutral 😐"
                    
                    df_filtered['Sentiment Class'] = df_filtered['sentiment'].apply(get_sent_label)
                    fig_sent = px.pie(df_filtered, names='Sentiment Class', 
                                      color_discrete_map={"Positive 😊":"#34A853", "Neutral 😐":"#FBBC05", "Negative 😡":"#EA4335"},
                                      template="plotly_white", hole=0.45)
                    fig_sent.update_layout(margin=dict(l=20, r=20, t=20, b=20), height=300)
